...
void SampleApp_SendPointToPointMessage( void )
{
  ...
  rftx.BUF.value[0] = 'D';
  rftx.BUF.value[1] = wendu_shi+48;
  rftx.BUF.value[2] = wendu_ge%10+48;
  
  rftx.BUF.value[3] = shidu_shi+48;
  rftx.BUF.value[4] = shidu_ge%10+48;
  ...
  if ( AF_DataRequest( &Point_To_Point_DstAddr,
                      &SampleApp_epDesc,
                      SAMPLEAPP_POINT_TO_POINT_CLUSTERID_DHT11,
                      20,
                      (uint8 *)&rftx,
                      &SampleApp_TransID,
                      AF_DISCV_ROUTE,
