...
#define SAMPLEAPP_MAX_CLUSTERS       7 //2
#define SAMPLEAPP_PERIODIC_CLUSTERID 1
#define SAMPLEAPP_FLASH_CLUSTERID    2
#define SAMPLEAPP_POINT_TO_POINT_CLUSTERID  3
#define SAMPLEAPP_POINT_TO_POINT_CLUSTERID_DHT11  4
#define SAMPLEAPP_POINT_TO_POINT_CLUSTERID_LIGHT  5
//#define SAMPLEAPP_POINT_TO_POINT_CLUSTERID_INF 6
#define SAMPLEAPP_POINT_TO_POINT_CLUSTERID_REMOTE 7
